...
file_scenario_params=strcat('D:/matlabcode/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.params.mat');
...
for t=1:1:params.num_BS
    if sum(t == params.active_BS) ==1
        filename_DoD=strcat('D:/matlabcode/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.',int2str(t),'.DoD.mat');
        filename_CIR=strcat('D:/matlabcode/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.',int2str(t),'.CIR.mat');
        filename_Loc=strcat('D:/matlabcode/RayTracing Scenarios/',params.scenario,'/',params.scenario,'.Loc.mat');
